...
//            修改和增加
            add(){
                if(this.update===true)
                {
//                    this.detail.splice(this.clickIndex,1,data);
                    this.tableData.splice(this.index,1,this.form)
                    this.update=false;

                }
                else {
                    this.tableData.push({name: this.form.name, date: this.form.date, address: this.form.adress})
//                this.detail.push({name : data, age : data1, date : data2});
